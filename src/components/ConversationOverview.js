        ...
        return this.transferPropsTo(
            <div className="list-group-item row">
                ...
                <div className="col-xs-9">
                    <h4 className="list-group-item-heading">User Name > <a href='#' ref='careTeam'>{this.props.name}</a></h4>
                    <span ref='noteWhen small'>{this.props.when}</span>
                    <p ref='noteText' className="list-group-item-text">{this.props.latestNoteSummary}</p>
                    <a href='#' ref='noteThread'>Comment stuff</a>
                </div>
            </div>
        );
    }
