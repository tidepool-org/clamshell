    ...
    render: function() {
        return this.transferPropsTo(
            <div className="note list-group-item row">
                <div className={this.props.imgColumns}>
                ...
                <div className={this.props.detailColumns}>
                    <h4 ref='messageAuthorAndGroup' className="note-header list-group-item-heading">{this.props.author} User Name > <a onClick={this.props.onGroupSelected} ref='careTeam'>{this.props.name}</a></h4>
                    ...
                    <a ref='showMessageThread' className='note-link'>Comment stuff</a>
                </div>
            </div>
        );
    }
