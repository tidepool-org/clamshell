        ...
        return this.transferPropsTo(
            <div className="list-group-item row">
                ...
                <div className="col-xs-10">
                    <h4 ref='messageAuthorAndGroup' className="list-group-item-heading">{this.props.author} User Name > <a onClick={this.props.onGroupSelected} ref='careTeam'>{this.props.name}</a></h4>
                    <span ref='messageWhen' className=''>{this.props.when}</span>
                    <p ref='messageText' className="list-group-item-text">{this.props.note}</p>
                    <a ref='showMessageThread' >Comment stuff</a>
                </div>
            </div>
        );
    }
