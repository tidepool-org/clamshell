        ...
        return(
            ...
            <div className="list-group-item row">
                ...
                <div className="col-xs-9">
                    <h4 className="list-group-item-heading">{message.form}User Name</h4>
                    <span ref='noteWhen small'>{this.props.when}</span>
                    <p ref='noteText' className="list-group-item-text">{message.messagetext}</p>
                </div>
            </div>
            /* jshint ignore:start */
        );
