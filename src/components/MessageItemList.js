...
var MessageItemList = React.createClass({
        ...
        return(
            ...
            <div ref='' className="list-group-item row">
                ...
                <div className="col-xs-9">
                    <h4 ref='authorName' className="list-group-item-heading">{message.form}User Name</h4>
                    <span ref='messageWhen' className='small'>{this.props.when}</span>
                    <p ref='messageText' className="list-group-item-text">{message.messagetext}</p>
                </div>
            </div>
            /* jshint ignore:start */
        );
        ...
        return (
            ...
            <div className="list-group-item row">
                ...
                <div className="col-xs-7">
                    <h4 ref='authorName' className="list-group-item-heading">{message.from}User Name</h4>
                    <span ref='messageWhen' className='small'>{this.props.when}</span>
                    <p ref='messageText' className="list-group-item-text">{message.messagetext}</p>
                </div>
            </div>
    ...
    render: function() {
        ...
        return (
        	/* jshint ignore:start */
            <div ref='messageThread' className="list-group">
                {items}
            </div>
            /* jshint ignore:end */
        );
